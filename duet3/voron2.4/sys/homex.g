...
G1 H1 X500 F9000        ; move quickly to X and Y axis endstops and stop there (first pass)
G1 H2 X-5 Y-5 F900      ; go back a few mm
G1 H1 X500 F360         ; move slowly to X and Y axis endstops once more (second pass)
